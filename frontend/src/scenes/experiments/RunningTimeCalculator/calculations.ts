...
export function baselineStatsFromResults(
    ...
    return {
        ...
        denominator_sum: baseline.denominator_sum,
        denominator_sum_squares: baseline.denominator_sum_squares,
        numerator_denominator_sum_product: baseline.numerator_denominator_sum_product,
